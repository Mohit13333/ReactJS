...
[password])
  ...
  return (
    <>
      ...
      <div className='classNmae="flex shadow rounded-lg overflow-hidden mb-4"'>
      <input type="text" value={password} className='outline-none w-full py-1 px-3 rounded-lg flex' placeholder="password" readOnly />
